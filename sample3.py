...
def forward(x, w1, b1, w2, b2):
    ...
    if debug > 1:
        print("1 out:")
        print(layer1Out.flatten())
        print("2 in:")
        print(layer2In.flatten())
        print("2 out:")
        print(layer2Out.flatten())
        debug -= 1
...
np.savez('test.npz', w1=w1, b1=b1, w2=w2, b2=b2)
